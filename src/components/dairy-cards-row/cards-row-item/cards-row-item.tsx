  ...
  return (
    <main className={styles.itembox}>
      <div className={styles.titlepanel}>
        ...
        <a className={styles.opendiary} href={card.link}>
          Открыть полный отчет
        </a>
        <button className={styles.editdiary}>
          <Edit />
        </button>
      </div>
      <div className={styles.generalinfo}>
        <div>
          ...
          <p className={styles.value}>
            {card.calories} <span className={styles.unit}>ккал</span>
          </p>
        </div>
        <div className={styles.centralgrid}>
          <p className={styles.subtitle}>Белок</p>
          <p className={styles.value}>
            {card.proteins} <span className={styles.unit}>гр</span>
          </p>
        </div>
        <div>
          <p className={styles.subtitle}>Вес</p>
          <p className={styles.value}>
            {card.weight} <span className={styles.unit}>кг</span>
          </p>
        </div>
      </div>
    </main>
