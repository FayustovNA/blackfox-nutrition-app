...
function BasicMacrosChart() {
    ...
    return (
        <ReactApexChart options={data.options} series={data.series} type="line" height={220} />
    );
}

export default BasicMacrosChart;